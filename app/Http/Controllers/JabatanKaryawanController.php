...
class JabatanKaryawanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('jabatan_karyawan.index', compact('jabatanKaryawan'));
    }
    ...
    public function create()
    {
        ...
        return view('jabatan_karyawan.tambah', compact('jabatan', 'karyawan'));
    }
    ...
    public function edit(JabatanKaryawan $jabatanKaryawan)
    {
        $jabatan = Jabatan::all();
        $karyawan = Karyawan::all();
        return view('jabatan_karyawan.edit', compact('jabatanKaryawan', 'jabatan', 'karyawan'));
    }
